...
import {
  ...
  Users, Leaf, Receipt, AlertTriangle, Menu, X,
} from "lucide-react"
  ...
  return (
    <>
      <div className="flex items-center gap-2 px-5 py-5 border-b" style={{ borderColor: "var(--dk-border)" }}>
        <div className="w-7 h-7 rounded-md flex items-center justify-center" style={{ background: "var(--dk-brand)" }}>
      ...
      <div className="px-5 py-4 border-t" style={{ borderColor: "var(--dk-border)" }}>
        <p style={{ fontSize: "var(--dk-text-xs)", color: "var(--dk-fg-2)" }}>DClaw Waste v1.3</p>
      </div>
    </>
  )
}
