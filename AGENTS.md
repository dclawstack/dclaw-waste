...
**DClaw Waste** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8054` (FastAPI)
- **Frontend Port:** `3054` (Next.js)
- **Database:** `dclaw_waste` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3054`
